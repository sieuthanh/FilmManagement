...
public class AddStar extends javax.swing.JDialog{
    ...
    public AddStar(String selectedId) {
    	super();
    ...
    private void AddManager() {
        ...
        if (FilmController.insertStarLink(selectedfID, selectedID)) {
            new CustomMessageDialog(null, true, "Done!", "Add sucessfully!", CustomMessageDialog.DONE);
            EditMovie.reloadStarTable();
        }
    }
